...
func EcsAppDefinition(e aws.Environment, workloadName string, clusterArn pulumi.StringInput, placementConstraints classicECS.ServicePlacementConstraintArrayInput, opts ...pulumi.ResourceOption) (*EcsComponent, error) {
