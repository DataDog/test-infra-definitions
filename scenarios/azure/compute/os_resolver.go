...
func resolveWindowsAMI(e azure.Environment, osInfo os.Descriptor) (string, error) {
...
func resolveUbuntuAMI(e azure.Environment, osInfo os.Descriptor) (string, error) {
	if osInfo.Version == "" {
		osInfo.Version = os.UbuntuDefault.Version
	}

	switch osInfo.Version {
	case os.Ubuntu_2204.Version:
